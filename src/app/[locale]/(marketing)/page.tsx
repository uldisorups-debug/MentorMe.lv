...
async function loadDirectory(locale: string) {
  ...
  const [taxonomy, coachesResult] = await Promise.all([
    ...
    supabase
      ...
      .select(
        'id, slug, full_name, tagline, avatar_url, certification, is_verified, years_experience, session_languages, price_tier, price_from, price_to, niches, teaching_format, region_slug, city, for_tourists, avg_rating, review_count, profile_views, created_at'
      )
